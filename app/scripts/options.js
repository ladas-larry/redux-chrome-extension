...
function chromeExtensions(state, action) {
  ...
  switch (action.type) {
    case _actionsChromeExtensionJs.UPDATE_STATE:
      ...
      localStorage.setItem('persistent', newState.persistent);
      return newState;
    default:
      return state;
  }
